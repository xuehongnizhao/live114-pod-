...
@interface orderSeatTableViewCell()
...
@implementation orderSeatTableViewCell
...
/**
 配置商家列表cell各种控件显示和位置
 */
-(void)confirgure:(orderSeatInfo*)info
{
    //---shop picture----
    ...
    [_rev_type autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_score withOffset:3.0f];
    ...
    [_shop_address autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_score withOffset:3.0f];
