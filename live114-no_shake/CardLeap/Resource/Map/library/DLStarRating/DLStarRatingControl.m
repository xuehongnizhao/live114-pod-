...
- (void)setStars:(NSUInteger)_numberOfStars andFractional:(BOOL)isFract
{
...
- (void)setupView {
    ...
    currentIdx = -1;
    star = [UIImage imageNamed:@"外卖-菜品详细-星星3.png"];
    highlightedStar = [UIImage imageNamed:@"外卖-菜品详细-星星.png"] ;
