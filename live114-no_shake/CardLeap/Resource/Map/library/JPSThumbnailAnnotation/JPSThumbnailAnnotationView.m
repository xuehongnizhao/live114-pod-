...
-(void)setColor :(NSString*)str
{
    if ([str isEqualToString:@"1"]) {
        _strokeAndShadowLayer.fillColor = UIColorFromRGB(0x4fb6f7).CGColor;
    }else{
        _strokeAndShadowLayer.fillColor = [UIColor colorWithRed:228/255.0 green:70/255.0 blue:78/255.0 alpha:1.0].CGColor;
    }
}
//点击效果可能在这里做
- (void)setLayerProperties {
    ...
    if (JPSThumbnailAnnotationViewShadowVisible) {
        _strokeAndShadowLayer.shadowColor = [UIColor clearColor].CGColor;
    ...
    //_strokeAndShadowLayer.borderWidth = 1;
    _strokeAndShadowLayer.borderColor = [[UIColor colorWithRed:178/255.0 green:178/255.0 blue:178/255.0 alpha:1.0] CGColor];
