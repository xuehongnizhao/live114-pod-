...
group_endtime,now_price,before_price,group_id,end_time,pic,review_people,pic_list,shop_id,group_desc,share_url;
-(id)initWithDictionary:(NSDictionary*)dic
{
    if (!self) {
        self = [[groupDetailInfo alloc] init];
    }
    ...
    self.group_desc = [NSString stringWithFormat:@"%@",dic[@"group_desc"]];
