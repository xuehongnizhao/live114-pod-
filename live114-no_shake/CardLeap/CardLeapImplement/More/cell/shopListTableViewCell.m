...
#pragma mark ---- 12.11 地址显示
    ...
    [_area_name autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:_shop_pic withOffset:8.0f];
    [_area_name autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_score withOffset:8.0f];
    [_area_name autoSetDimension:ALDimensionWidth toSize:120.0f];
