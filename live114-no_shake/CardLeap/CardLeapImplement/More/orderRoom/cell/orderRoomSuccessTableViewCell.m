//
//  orderRoomSuccessTableViewCell.m
//  CardLeap
//
...
@interface orderRoomSuccessTableViewCell()
...
@implementation orderRoomSuccessTableViewCell
...
-(void)confirgureCell:(orderRoomSuccessInfo*)info row:(NSInteger)row
{
    if (row == 0) {
        ...
        _seat_num.text = [NSString stringWithFormat:@"%@人",info.hotel_num];
    }else if (row == 2){
        self.selectionStyle = UITableViewCellSelectionStyleNone;
