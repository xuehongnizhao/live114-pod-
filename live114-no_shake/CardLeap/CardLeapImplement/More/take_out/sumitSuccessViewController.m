...
-(void)setUI
{
    ...
    [_backShopButton autoSetDimension:ALDimensionWidth toSize:120.0f*LinPercent];
    ...
    [_checkOrderButton autoSetDimension:ALDimensionWidth toSize:120.0f*LinPercent];
