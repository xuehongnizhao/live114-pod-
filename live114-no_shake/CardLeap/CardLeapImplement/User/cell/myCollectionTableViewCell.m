...
{
    UIImageView *_vip_pic;
    UIImageView *_rezheng_pic;
}
@property (strong, nonatomic) UIImageView *shop_pic;//商家图片
@property (strong, nonatomic) UILabel *shop_name;//商家名称
@property (strong, nonatomic) UIView *score;//评分view
@property (strong, nonatomic) UILabel *area_name;//商圈名称
@property (strong, nonatomic) UILabel *num_estimate;//
@property (strong, nonatomic) UILabel *type;//类型
@property (strong, nonatomic) UIImageView *group_pic;//团购pic
@property (strong, nonatomic) UIImageView *take_pic;//外卖图片
@property (strong, nonatomic) UIImageView *oreder_pic;//订酒店订座位图片
@property (strong, nonatomic) UIImageView *activity_pic;//活动图片
...
-(void)confirgureCell:(myCollectionInfo*)info
{
    //商铺图片
...
#pragma mark --- 2016.4  将团购优惠等图标向下向左移动修改的不好
    ...
    //_shop_name.layer.borderWidth = 1;
    ...
    [_shop_name autoPinEdge:ALEdgeRight toEdge:ALEdgeLeft ofView:_rezheng_pic withOffset:-3.0f];
    ...
    _area_name.font = [UIFont systemFontOfSize:13.0];
    _area_name.text = info.shop_address;
    ...
    [_area_name autoSetDimension:ALDimensionWidth toSize:130.0f];
    ...
    _num_estimate.font = [UIFont systemFontOfSize:13.0];
    //    _num_estimate.text = [NSString stringWithFormat:@"%@评价",info.rev_people];
    [_num_estimate autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:_score withOffset:17.0f];
    [_num_estimate autoPinEdgeToSuperviewEdge:ALEdgeTop withInset:34.0f];
    [_num_estimate autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:35.0f];
    [_num_estimate autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:13.0f];
    //菜品种类
    _type = [[UILabel alloc] initForAutoLayout];
    [self.contentView addSubview:_type];
    _type.textColor = UIColorFromRGB(addressTitle);
    _type.font = [UIFont systemFontOfSize:13.0];
    _type.textAlignment = NSTextAlignmentRight;
    _type.text = info.shop_cate;
