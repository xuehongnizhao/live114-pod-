//
//  myOrderSeatCenterTableViewCell.m
//  CardLeap
//
...
@property (strong,nonatomic)UILabel *seat_num;//订座位数量
@end

@implementation myOrderSeatCenterTableViewCell
...
-(void)confirgureCell:(myOrderSeatCenterInfo*)info row:(NSInteger)row
{
    ...
    [_seat_time autoPinEdgeToSuperviewEdge:ALEdgeRight withInset:90.0f];
    ...
    [_seat_num autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:_seat_time withOffset:3.0f];
    ...
    if ([info.confirm_status isEqualToString:@"1"]) {
        ...
        [_order_status autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_seat_num withOffset:5.0f];
        ...
        [_reviewButton autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_seat_num withOffset:5.0f];
        ...
        [_scoreView autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_seat_num withOffset:5.0f];
...
-(UILabel *)order_status
{
    if (!_order_status) {
        ...
        _order_status.textColor = UIColorFromRGB(0x85bfca);
    }
